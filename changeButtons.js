...
const buttonsById = [
    'share', 'show-video', 'stop-video', 'mute-audio', 'unmute-audio', 'leave-meeting', 'change-size', 'start-record', 'stop-record','play-record', 'pause-record', 'resume-record', 'share-screen'
]
